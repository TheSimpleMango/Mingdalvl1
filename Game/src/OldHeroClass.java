...
public class OldHeroClass extends JPanel implements MouseListener{
	...
	int settingsButtonY2 = 300-(buttonHeight/2)-20+buttonHeight;
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (mX > startButtonX1 && mX < startButtonX2 && mY > startButtonY1 && mY < startButtonY2) {
			...
			System.out.println("settingsButton2" + settingsButtonX1 + ", " + settingsButtonX2 + ", " + settingsButtonY1 + ", " +  settingsButtonY2);
			
		}
		else if (mX > exitButtonX1 && mX < exitButtonX2 && mY > exitButtonY1 && mY < exitButtonY2) {
			System.out.println("EXIT" + exitButtonX1 + ", " + exitButtonX2 + ", " + exitButtonY1 + ", " +  exitButtonY2);
			
		}
		else if (mX > 10 && mX < 10 && mY > 50 && mY < 25) {
			System.out.println("startgameBackButton" + 10 + ", " + 10 + ", " + 50 + ", " +  25);
			Hero x = new Hero();
			x.start();
		}
	}

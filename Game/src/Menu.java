...
public class Menu extends JPanel implements MouseListener {
	...
	public void paint(Graphics g) {
		...
		else if (gameState == HELP_STATE) {
			g.drawImage(backgroundImage, 0, 0, null);
			g.setColor(Color.white);
			g.fillRect(10, 10, 40, 15);
			g.fillRect(222, 240, 185, 25);
			g.fillRect(217, 265, 195, 25);
			
			g.setColor(Color.black);
			g.drawString("<back", 10, 22);
			g.setFont(font);
			g.drawString("Use arrows to move", 225, 260);
			g.drawString("Press space to shoot", 220, 285);
		}
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (gameState == MENU_STATE) {
			...
			if (mX > firstButtonX1 && mX < firstButtonX2 && mY > firstButtonY1
					&& mY < firstButtonY2) {
				System.out.println("settingsButton1" + firstButtonX1 + ", "
						+ firstButtonX2 + ", " + firstButtonY1 + ", "
						+ firstButtonY2);
			} else if (mX > secondButtonX1 && mX < secondButtonX2
					&& mY > secondButtonY1 && mY < secondButtonY2) {
				System.out.println("settingsButton2" + secondButtonX1 + ", "
						+ secondButtonX2 + ", " + secondButtonY1 + ", "
						+ secondButtonY2);
				System.out.println(gameState);
			} else if (mX > thirdButtonX1 && mX < thirdButtonX2
					&& mY > thirdButtonY1 && mY < thirdButtonY2) {
				System.out.println("settingsButton3" + thirdButtonX1 + ", "
						+ thirdButtonX2 + ", " + thirdButtonY1 + ", "
						+ thirdButtonY2);
			} else if (mX > 10 && mX < 50 && mY > 10 && mY < 25
					&& gameState == HELP_STATE) {
				System.out.println("settingsBackButton" + 10 + ", " + 10 + ", "
						+ 50 + ", " + 25);
				System.out.println(gameState);
